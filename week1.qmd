...
![**Left:** Average 2m air temperature at 23h (moment of max Urban Heat Islands) during all summer months of the years 1987- 2016. **Right:** UrbCLIM climate model's output field showing the average daily maximum urban heat island intensity for Amsterdam](images/clipboard-1067784336.png){fig-align="center"}
